...
<html>
    ...
    <body>
        <div>
            ...
            <div class="conteiner">
                <h1 class="space_title">Funcionários <input type="image" class="icon" src="imagens/plus-circle-outline.png" onclick="callRegister('funcionario_add.php', 'Funcionário')"></h1>
                <div class="space">
